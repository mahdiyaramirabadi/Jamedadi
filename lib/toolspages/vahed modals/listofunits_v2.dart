...
List zarib_list2 = ["پیشوند خواسته شده", 0];

class listofunits_v2 extends StatelessWidget {
  final bool reverse;

  const listofunits_v2({Key? key, this.reverse = false}) : super(key: key);
